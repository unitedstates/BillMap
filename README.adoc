...
NOTE: the steps below have been superceded by Django manage.py commands which download the data and populate the database: https://github.com/aih/FlatGov/blob/master/django_database.adoc
