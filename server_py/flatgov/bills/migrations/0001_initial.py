    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leadership', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsor', models.JSONField(blank=True, default=dict)),
                ('related_bills', models.JSONField(blank=True, default=list)),
                ('related_dict', models.JSONField(default=dict)),
                ('cosponsors_dict', models.JSONField(blank=True, default=list)),
                ('committees_dict', models.JSONField(blank=True, default=list)),
                ('es_similarity', models.JSONField(blank=True, default=list)),
                ('es_similar_reasons', models.JSONField(blank=True, default=dict)),
                ('es_similar_bills_dict', models.JSONField(blank=True, default=dict)),
