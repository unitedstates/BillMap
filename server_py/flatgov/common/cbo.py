...
from common.constants import CURRENT_CONGRESS, CURRENT_CONGRESSIONAL_YEAR
...
def collect_cbo_data_into_json(rootDir=constants.PATH_TO_CONGRESSDATA_DIR, processFile=logName,
                               dirMatch=getTopBillLevel, fileMatch=isDataXML):
