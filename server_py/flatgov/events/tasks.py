...
from events.tasks_ical import process_ical
from events.tasks_senate_floor import process_xml_senate_floor
from events.tasks_senate_committee import process_xml_senate_committee
from events.tasks_house_committee import process_html_house_committee
        ...
        if latestSource:
            ...
            if previousEntryForSource:
                if latestSource.created > previousEntryForSource.created:
                    ...
                    # Consider synchronizing events if we start storing additional metadata in our DB in the future
                    process = True
                else:
